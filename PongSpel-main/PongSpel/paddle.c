...
Paddle* initialize_paddle(SDL_Renderer* renderer) {      //  paddle on the bottom of the screen
...
void update_paddle(Paddle* paddle, Paddle* paddle2, Paddle* paddle3, Paddle* paddle4, float delta_time, int playerIndex) {
    ...
    if (state[SDL_SCANCODE_D] && playerIndex == 1) {
